...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { firstname: @actor.firstname, lastname: @actor.lastname, movie_id: @actor.movie_id } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { firstname: @actor.firstname, lastname: @actor.lastname, movie_id: @actor.movie_id } }
